...
export function SampleCertificatePage({ order, clientName, onClose, headerSlot, machines: machinesProp, activeSection = 'cert', userRole, userName, sampleId, onCreateFabric }: {
  ...
  }, [order.id, clientName, order.material, sampleId, userName]);
